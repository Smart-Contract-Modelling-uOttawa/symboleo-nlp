...
from app.src.pattern_builder.inner_pattern_checker import IInnerPatternChecker
from app.src.pattern_builder.all_patterns_getter import IGetAllPatterns
...
class PatternGetterTests(unittest.TestCase):
    def setUp(self):
        ...
        self.sut = PatternChecker(self.fake_getter, self.fake_inner)
