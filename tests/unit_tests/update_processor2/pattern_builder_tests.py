...
from app.src.update_processor2.pattern_class_extractor import IExtractPatternClass
from app.src.update_processor2.pattern_class_filler import IFillPatternClass
