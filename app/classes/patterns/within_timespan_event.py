...
class WithinTimespanEvent(EventPattern):
    sequence = [UnitType.ROOT, UnitType.WITHIN, UnitType.TIMESPAN, UnitType.OF, UnitType.EVENT]
    timespan: Timespan
    ...
    def to_text(self):
        return f'within {self.timespan.to_text()} of {self.nl_event.to_text(ConjType.CONTINUOUS)}'
