...
from app.src.pattern_builder.pattern_unit_fillers.timespan_value_filler import TimespanValueFiller
from app.src.pattern_builder.pattern_unit_fillers.timespan_unit_filler import TimespanUnitFiller
