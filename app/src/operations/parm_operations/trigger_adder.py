...
# TODO: Once I clear this ith the team, I may need to separate out trigger and antecedent...

class TriggerAdder(IUpdateParameter):
    def __init__(
        self,
    ...
    def update(self, contract: SymboleoContract, config: ParameterConfig, update_obj: PredicateFunction):
        ...
        new_config.norm_component = 'trigger'
        result = self.__processor.process(new_config, contract, update_obj)
        return result
