...
from app.src.operations.configs import DomainPropProcessorConfig

class IAddDomainProps:
    def add(self, config: DomainPropProcessorConfig, contract: SymboleoContract, new_prop: DomainProp) -> SymboleoContract:
