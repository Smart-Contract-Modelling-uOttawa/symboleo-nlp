...
nl_template = NLTemplate(
    template_dict = {
        ...
        'partial_completion': TemplateObj(
            'In the event that this Agreement is terminated prior to completion of the Services, but where the Services have been partially performed, the Contractor will be entitled to pro rata payment of the Compensation to the date of termination provided that there has been no breach of contract on the part of the Contractor.'
        ),
