...
def get_contract_spec():
    ...
    parameters = [
        ...
        ContractSpecParameter('var_days_notice', 'Number'), # X
    ...
    evt_legal_proceedings = Declarer.declare(dm, 'events', 'LegalProceedingsNecessary', 'evt_legal_proceedings_necessary', [
        ('property', PROPERTY)
    ])
    ...
    declarations = {
        ...
        'evt_legal_proceedings_necessary': evt_legal_proceedings,
    ...
    contract_spec = ContractSpec(
        ...
        obligations = {
            ...
            ## Use case for coreference ("such" legal proceeding...)
